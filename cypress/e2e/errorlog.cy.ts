...
describe('test: error log', () => {
  beforeEach(() => {
    ...
    cy.get('#debug-mode-checkbox').click({ force: true });
  });
  ...
  it('startup: error log should not be visible', () => {
    ...
    cy.get('#display-errors').click({ force: true });
  ...
  it('content: should contain errors', () => {
    ...
    cy.get('#punctum').click({ force: true });
    cy.get('#svg_group').click(5, 5, { force: true });
  ...
  it('content: should contain warnings', () => {
    ...
    cy.get('#remove-empty-syls').click({ force: true });
    ...
    cy.get('#remove-empty-neumes').click({ force: true });
